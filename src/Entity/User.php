...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     */
    #[ORM\OneToMany(targetEntity: JobApplication::class, mappedBy: 'utilisateur')]
    ...
    public function addJobapplication(JobApplication $jobapplication): static
    {
        if (!$this->jobapplications->contains($jobapplication)) {
            ...
            $jobapplication->setUtilisateur($this);
        }
    ...
    public function removeJobapplication(JobApplication $jobapplication): static
    {
        if ($this->jobapplications->removeElement($jobapplication)) {
            ...
            if ($jobapplication->getUtilisateur() === $this) {
                $jobapplication->setUtilisateur(null);
            }
        }
